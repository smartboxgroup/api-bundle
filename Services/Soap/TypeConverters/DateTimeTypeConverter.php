...
class DateTimeTypeConverter extends \BeSimple\SoapCommon\Converter\DateTimeTypeConverter
{
    ...
    public function convertXmlToPhp($data)
    {
        try {
            ...
            throw new SenderSoapFault(sprintf('SOAP-ERROR: Encoding: Violation of encoding rules in date property, found "%s", hence a valid datetime was expected', $content));
        }
    }
}
